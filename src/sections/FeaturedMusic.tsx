  ...
  return (
    <section className="bg-[#181818] text-white px-6 md:px-12 lg:px-20 py-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <h2 className="text-3xl md:text-4xl font-bold">Música destacada</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
          ...
          <div className="bg-[#242424] rounded-xl p-4 hover:bg-[#2a2a2a] transition">
            ...
            <p className="text-[#B3B3B3] text-sm mt-1">Artista destacado</p>
          </div>
          ...
          <div className="bg-[#242424] rounded-xl p-4 hover:bg-[#2a2a2a] transition">
            ...
            <h3 className="font-bold text-lg">Sonidos nuevos</h3>
          ...
          <div className="bg-[#242424] rounded-xl p-4 hover:bg-[#2a2a2a] transition">
            ...
            <h3 className="font-bold text-lg">Ritmo urbano</h3>
          ...
          <div className="bg-[#242424] rounded-xl p-4 hover:bg-[#2a2a2a] transition">
            ...
            <h3 className="font-bold text-lg">Lo más escuchado</h3>
