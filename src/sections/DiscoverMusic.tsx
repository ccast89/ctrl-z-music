      ...
      <div className="max-w-5xl mx-auto">
        <div className="bg-[#1DB954] rounded-3xl px-8 py-12 md:px-16 md:py-16 text-center">
          ...
          <p className="text-black/70 text-lg max-w-2xl mx-auto mb-8">
            Encontrá nuevos artistas, canciones y géneros. Siempre hay algo
            nuevo para escuchar.
          </p>

          <Link
            to="/biblioteca"
            className="bg-black text-white font-bold px-8 py-3 rounded-full hover:bg-[#242424] transition inline-block"
          >
            Comenzar a explorar
          </Link>
        </div>
