        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                to="/biblioteca"
                className="bg-[#1DB954] text-black font-bold px-7 py-3 rounded-full hover:bg-[#1ED760] transition"
              >
                Explorar música
              </Link>
              ...
              <Link
                ...
                className="border border-[#555] text-white font-semibold px-7 py-3 rounded-full hover:border-[#1DB954] hover:text-[#1DB954] transition"
              >
                Descubrir artistas
              </Link>
            </div>
          ...
          <div className="flex justify-center lg:justify-end lg:translate-y-8">
            <div className="relative w-[300px] h-[300px] md:w-[380px] md:h-[380px] lg:w-[430px] lg:h-[430px]">
              ...
              {/* CÍRCULO MEDIO */}
              <div className="absolute inset-8 rounded-full border border-[#1DB954]/30 bg-[#1DB954]/10"></div>
              ...
              <div className="absolute inset-20 md:inset-24 rounded-full bg-[#1DB954] flex items-center justify-center shadow-[0_0_80px_rgba(29,185,84,0.25)]">
                <div className="text-center">
                  ...
                  <p className="text-black font-bold text-sm">ESCUCHÁ</p>
                </div>
              </div>
